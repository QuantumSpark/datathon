...
@app.route('/')
def plotPointsOnMap():
    rawTrafficSignal = pd.read_csv('/Users/QuantumSpark/Developer/trafficsignals.csv')
    trafficCameras = pd.read_csv('/Users/QuantumSpark/Developer/timagesopendataarchivescsvmonthlytrafficcameras.csv')
